 ...
 *
 * @author Raul Marticorera - Iván Ruiz Gázquez
 * @since 1.0
 * @version 2.0
 */
public class Ajedrez {
	 ...
	 */
	public static void main(String[] args) throws CoordenadasIncorrectasException {
		try {
			String jugada = "";
			...
			System.out.println("\n----------AJEDREZ---------\n");
			while(!comprobarSiFinalizaUsuarioPartida(jugada)) {
				...
				else if(!comprobarSiFinalizaUsuarioPartida(jugada))
					mostrarErrorEnFormatoDeEntrada();
			}
			
			System.out.println("\nVuelve cuando quieras a rockear en el ajedrez!!");
			finalizarPartida();
		}
		catch(Exception e) {
