...
public class Arbitro {
	...
	public void colocarPiezas() {
		...
		// Coloca resto de piezas.
		piezasBlancas[1][0] = new Pieza(Tipo.TORRE, Color.BLANCO);
		piezasBlancas[1][1] = new Pieza(Tipo.CABALLO, Color.BLANCO);
		piezasBlancas[1][2] = new Pieza(Tipo.ALFIL, Color.BLANCO);
		piezasBlancas[1][3] = new Pieza(Tipo.DAMA, Color.BLANCO);
		piezasBlancas[1][4] = new Pieza(Tipo.REY, Color.BLANCO);
		piezasBlancas[1][5] = new Pieza(Tipo.ALFIL, Color.BLANCO);
		piezasBlancas[1][6] = new Pieza(Tipo.CABALLO, Color.BLANCO);
		piezasBlancas[1][7] = new Pieza(Tipo.TORRE, Color.BLANCO);

		piezasNegras[0][0] = new Pieza(Tipo.TORRE, Color.NEGRO);
		piezasNegras[0][1] = new Pieza(Tipo.CABALLO, Color.NEGRO);
		piezasNegras[0][2] = new Pieza(Tipo.ALFIL, Color.NEGRO);
		piezasNegras[0][3] = new Pieza(Tipo.DAMA, Color.NEGRO);
		piezasNegras[0][4] = new Pieza(Tipo.REY, Color.NEGRO);
		piezasNegras[0][5] = new Pieza(Tipo.ALFIL, Color.NEGRO);
		piezasNegras[0][6] = new Pieza(Tipo.CABALLO, Color.NEGRO);
		piezasNegras[0][7] = new Pieza(Tipo.TORRE, Color.NEGRO);
	...
	public boolean estaEnJaqueTrasSimularMovimientoConTurnoActual(Celda origen, Celda destino) {
		...
		// Comprobamos.
		if(this.estaEnJaque(origen.obtenerColorDePieza()))
			estaEnJaque = true;
