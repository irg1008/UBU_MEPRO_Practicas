...
public class Arbitro {
	 ...
	 */
	private boolean comprobarPiezaEnMedio(Celda origen, Celda destino) {
	 ...
	 *  <li>Pueden mover solo si el destino esta vacio o hay enemigo.</li>
	 *  <li>No pueden moverse sobre si mismas.</li>
	 *  <li>Solo puedes mover las piezas del color del turno actual.</li></ul>
	 *
	...
	private boolean esLegalPeon(Celda origen, Celda destino, Sentido sentido) {
		if(!this.comprobarPiezaEnMedio(origen, destino)) {
	...
	public boolean estaEnJaque(Color color) {
		...
		celdaRey = this.detectarPosicionReySegunColor(color);
